...
exports.deserialize = exports.serialize = exports.toRabinSig = exports.Rabin = void 0;
/*
...
class Rabin {
     ...
     */
    constructor(securityLevel = 6) {
        this.securityLevel = securityLevel < 1 ? 1 : securityLevel;
    }
    greatestCommonDivisor(a, b) {
        a = (0, utils_1.bigIntAbsoluteValue)(a);
        b = (0, utils_1.bigIntAbsoluteValue)(b);
        if (b > a) {
            let t = a;
            a = b;
            b = t;
    ...
    bin2hash(bytes) {
        const hBytes = (0, crypto_1.createHash)('sha256').update(bytes).digest();
        let idx = hBytes.byteLength / 2;
        let hl = (0, crypto_1.createHash)('sha256').update(hBytes.slice(0, idx)).digest();
        let hr = (0, crypto_1.createHash)('sha256').update(hBytes.slice(idx, hBytes.byteLength)).digest();
    ...
    rabinHashBytes(bytes) {
        ...
        return (0, bigint_buffer_1.toBigIntLE)(result);
    }
    ...
    root(dataBuffer, p, q, nRabin) {
        let signature, x, paddingByteCount = 0;
        while (true) {
    ...
    generatePrivKey() {
        ...
        let seed = (0, crypto_1.randomBytes)(2048);
    ...
    sign(dataHex, privKey) {
        ...
        if (!(0, utils_1.isHexString)(dataHex))

...
exports.SECP256R1 = void 0;
const scrypt_ts_1 = require("scrypt-ts");
class SECP256R1 extends scrypt_ts_1.SmartContractLib {
    ...
    static doublePoint(p) {
        const lambda = (3n * p.x * p.x + SECP256R1.a) *
    ...
    static addPoints(p, q) {
        ...
        if (p.x == 0n && p.y == 0n) {
            ...
            const lambda = SECP256R1.modReduce(N * SECP256R1.modInverseBranchlessP(D), SECP256R1.P);
            const rx = SECP256R1.modReduce(lambda * lambda - p.x - q.x, SECP256R1.P);
            const ry = SECP256R1.modReduce(lambda * (p.x - rx) - p.y, SECP256R1.P);
            ret = {
                x: rx,
                y: ry,
...
SECP256R1.CURVE_BITS = 256;
// Curve coefficients:
SECP256R1.a = 115792089210356248762697446949407573530086143415290314195533631308867097853948n;
SECP256R1.b = 41058363725152142129326129780047268409114441015993725554835256314039467401291n;
// Generator point:
SECP256R1.G = {
...
// Curve order:
SECP256R1.n = 115792089210356248762697446949407573529996955224135760342422259061068512044369n;
// Curve field value:
SECP256R1.P = 115792089210356248762697446949407573530086143415290314195533631308867097853951n;
// Upper bound of the eGCD mod inverse loop:
SECP256R1.UB = 368;
// Precalculated doublings for the generator point
SECP256R1.DOUBLINGS_G = [
    {
        x: 48439561293906451759052585252797914202762949526041747995844080717082404635286n,
        y: 36134250956749795798585127919587881956611106672985015071877198253568414405109n,
    },
...
__decorate([
    (0, scrypt_ts_1.prop)()
], SECP256R1, "DOUBLINGS_G", void 0);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "comparePoints", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "modReduce", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "modInverseBranchlessP", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "modInverseBranchlessN", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "modInverseEGCD", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "negatePoint", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "doublePoint", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "addPoints", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "mulByScalar", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "mulGeneratorByScalar", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "pubKey2Point", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "point2PubKey", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "toBEUnsigned32", null);
__decorate([
    (0, scrypt_ts_1.method)()
], SECP256R1, "verifySig", null);

...
exports.Mimc7 = void 0;
const scrypt_ts_1 = require("scrypt-ts");
class Mimc7 extends scrypt_ts_1.SmartContractLib {
    static hash(x, k) {
        let ret = 0n;
        for (let i = 0; i < Mimc7.ROUNDS; i++) {
            const t = i == 0 ? x + k : ret + k + Mimc7.CONSTS[i];
            const t2 = t * t;
            const t4 = t2 * t2;
            ret = (t4 * t2 * t) % Mimc7.SNARK_SCALAR_FIELD;
        }
        return (ret + k) % Mimc7.SNARK_SCALAR_FIELD;
    }
}
exports.Mimc7 = Mimc7;
Mimc7.ROUNDS = 91;
Mimc7.SNARK_SCALAR_FIELD = 21888242871839275222246405745257275088548364400416034343698204186575808495617n;
Mimc7.CONSTS = [
    0n,
...
__decorate([
    (0, scrypt_ts_1.prop)()
], Mimc7, "SNARK_SCALAR_FIELD", void 0);
__decorate([
    (0, scrypt_ts_1.prop)()
], Mimc7, "CONSTS", void 0);
__decorate([
